        ...
        <>
            ...
            :
                <Row className='mx-3 mt-5 mt-md-0'>
                    <Col sm="12" md="4" lg="3" onClick={createModalShow} className='border rounded mb-3 me-3' style={{cursor: 'pointer'}}>
                    ...
                    />
                    {cards.map(card => (
                        <Col sm="12" md="4" lg="3" className='border rounded mb-3 me-3'>
